...
% VS23_VB21_straight line
n = 0;
for i = [32 29 26 35 14]
    n = n+1;
...
[c1 h1] = contour(mlon,mprs,TEMP_cllcted(mprs(1,1):end,:),[0:0.1:1 5:1.5:20],'-w','LabelSpacing',1000);
clabel(c1,h1,'color','w');
xline(lon_mcllcted,'-r',{'VS23','VS17','VS11','VS5','VB21'},'LineWidth',.5,'LabelVerticalAlignment','bottom', ...
...
set(gca,'YDir','reverse');
caxis([34.0 34.5]);
[c1 h1] = contour(mlon,mprs,sal_cllcted(mprs(1,1):end,:),[34:0.1:34.5],'-w','LabelSpacing',1000);
clabel(c1,h1,'color','w');
xline(lon_mcllcted,'-r',{'VS23','VS17','VS11','VS5','VB21'},'LineWidth',.5,'LabelVerticalAlignment','bottom', ...
    'LabelHorizontalAlignment','center','FontWeight','b','FontName','Times New Roman','FontSize',13);
xlim([min(lon_mcllcted) max(lon_mcllcted)]);
...
set(gca,'YDir','reverse');
caxis([24.5 27.5]);
[c1 h1] = contour(mlon,mprs,dnsty_cllcted(mprs(1,1):end,:),[24.5:0.5:27.0 27.1],'-w','LabelSpacing',1000);
clabel(c1,h1,'color','w');
xline(lon_mcllcted,'-r',{'VS23','VS17','VS11','VS5','VB21'},'LineWidth',.5,'LabelVerticalAlignment','bottom', ...
    'LabelHorizontalAlignment','center','FontWeight','b','FontName','Times New Roman','FontSize',13);
xlim([min(lon_mcllcted) max(lon_mcllcted)]);
...
ax(4) = subplot(2,2,4);
pcolor(mlon,mprs,fl_cllcted(mprs(1,1):end,:));shading interp;hold on;
colormap('jet');
set(gca,'YDir','reverse');
caxis([0 1.3]);
[c1 h1] = contour(mlon,mprs,fl_cllcted(mprs(1,1):end,:),[0.2 0.3],'-w','LabelSpacing',1000);
clabel(c1,h1,'color','w');
xline(lon_mcllcted,'-r',{'VS23','VS17','VS11','VS5','VB21'},'LineWidth',.5,'LabelVerticalAlignment','bottom', ...
    'LabelHorizontalAlignment','center','FontWeight','b','FontName','Times New Roman','FontSize',13);
xlim([min(lon_mcllcted) max(lon_mcllcted)]);
...
title('Fluorescence','FontWeight','b','FontSize',22);
